...
prodRouter.post("/upload-productImage/:_id", prodController_1.checkproductId, multer_1.default.single("prod-Images"), fileValidation_1.imageValidaton, prodController_1.saveImage);
