...
const orderValidation = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { orderItems, shippingAddress, paymentMethod } = JSON.parse(JSON.stringify(req.body));
        ...
        ;
        totalPrice += 5;
        const orderSubmitData = { orderItems, shippingAddress, paymentMethod, totalPrice, user: req.username };
