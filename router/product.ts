...
import { imageValidaton, imagesValidaton } from "../Validation/fileValidation";
...
prodRouter.post("/upload-productImage/:_id", checkproductId, upload.single("prod-Images"), imageValidaton, saveImage);
